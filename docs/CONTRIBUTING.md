...
1. See our [open issues](https://github.com/iotaledger/documentation-markdown/issues)
...
5. Make sure that the base branch is `iotaledger/documentation-markdown@master` and the head branch is `<your username>/documentation-markdown@<your branch name>`
