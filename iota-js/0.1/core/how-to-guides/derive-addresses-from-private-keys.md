...
**By deriving [addresses](root://getting-started/0.1/basics/addresses.md) from private keys, you can gain a better understanding of the relationship among addresses, private keys, and security levels.**
