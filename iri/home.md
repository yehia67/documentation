# The IRI (IOTA reference implementation) is open-source software that detects counterfeit transactions and stores an immutible history of all transactions.
...
## Learn about the immutible ledger that's stored, distributed, and maintained by all IRI nodes in an IOTA network
