...
[ZMQ events](../references/zmq-events) are therefore also available in Flink.
...
If you run your own IRI, you have to [enable and to configure the ZMQ API.](../references/iri-configuration-options)
