...
[ZMQ events](../iri/0.1/references/zmq-events) are therefore also available in Flink.
...
If you run your own IRI, you have to [enable and to configure the ZMQ API.](../iri/0.1/references/iri-configuration-options)
