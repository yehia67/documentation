...
|`--keySecLevel` |[Security level](root://dev-essentials/0.1/references/security-levels.md) to use for IOTA [private keys](root://dev-essentials/0.1/concepts/addresses-and-signatures.md)|2|
