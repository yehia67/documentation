...
This endpoint gives you access to the [zero message queue](root://node-software/iri/0.1/concepts/zero-message-queue.md) of an IRI node on the Devnet.
...
This endpoint gives you access to the [zero message queue](root://node-software/iri/0.1/concepts/zero-message-queue.md) of an IRI node on the Spamnet.
