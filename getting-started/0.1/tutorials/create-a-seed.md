...
Now that you've got a seed, you can use it to [send your first data transaction with the Trinity wallet](../tutorials/send-your-first-zero-value-with-the-trinity-wallet.md).