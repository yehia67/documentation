...
|`mwm`|[Minimum weight magnitude](root://getting-started/0.1/basics/proof-of-work.md#minimum-weight-magnitude)|The higher the MWM, the harder it is to do the proof of work for a transaction.|
